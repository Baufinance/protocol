...
def test_create_4_coins_strategy(chain, common_health_check, base_fee_oracle,  cvx, crv, factory, curve_mock_builder, gov, weth, univ3_mock, univ2_mock, rewards_factory, booster, registry, vault_template):
  ...
  strategy3coins = gov.deploy(TestStrategyConvex4CoinsRewardsClonable)

  factory.setConvexStratImplementation(4, strategy3coins, {"from": gov})
  ...
  factory.setCurvePoolToRegistry(lp_token, 4, swap_path, {"from": gov})
  ...
  strategy = TestStrategyConvex4CoinsRewardsClonable.at(strategy_address)
  ...
  token4.approve(curve_pool, 1_000*10**18, {"from":gov})

  curve_pool.add_liquidity([1_000*10**18, 0, 0, 0], 0, {"from": gov})
...
def test_create_4_coins_strategy_with_deposit_withdraw_in_target_coin(chain, treasury, common_health_check, base_fee_oracle,  cvx, crv, factory, curve_mock_builder, gov, weth, univ3_mock, univ2_mock, rewards_factory, booster, registry, vault_template):
...
def test_create_4_coins_strategy_with_deposit_withdraw_in_target_coin_and_vault_deposit_fee(chain, rewards, treasury, common_health_check, base_fee_oracle,  cvx, crv, factory, curve_mock_builder, gov, weth, univ3_mock, univ2_mock, rewards_factory, booster, registry, vault_template):
  # try to build 2 pool with erc 20 tokens with plain and lending liquidity
  curve_mock_builder.build(4, False)
...
def test_create_4_coins_strategy_with_deposit_withdraw_in_target_coin_and_vault_deposit_fee_and_zap_unzap_targetcoin(zap, aggregationRouter, chain, rewards, treasury, common_health_check, base_fee_oracle,  cvx, crv, factory, curve_mock_builder, gov, weth, univ3_mock, univ2_mock, rewards_factory, booster, registry, vault_template):
  # try to build 2 pool with erc 20 tokens with plain and lending liquidity
  curve_mock_builder.build(4, False)
...
def test_create_4_coins_strategy_with_deposit_withdraw_in_target_coin_and_change_target_coin(chain, treasury, common_health_check, base_fee_oracle,  cvx, crv, factory, curve_mock_builder, gov, weth, univ3_mock, univ2_mock, rewards_factory, booster, registry, vault_template):
  # try to build 2 pool with erc 20 tokens with plain and lending liquidity
  curve_mock_builder.build(4, False)
  ...
  strategy2coins = gov.deploy(TestStrategyConvex4CoinsRewardsClonable)

  factory.setConvexStratImplementation(4, strategy2coins, {"from": gov})
...
def test_create_4_coins_strategy_with_deposit_withdraw_in_target_coin_as_eth(chain, treasury, common_health_check, base_fee_oracle,  cvx, crv, factory, curve_mock_builder, gov, weth, univ3_mock, univ2_mock, rewards_factory, booster, registry, vault_template):
  # try to build 2 pool with erc 20 tokens with plain and lending liquidity
...
def test_create_4_coins_strategy_with_deposit_withdraw_in_target_coin_lending_pool_susd(chain, treasury, common_health_check, base_fee_oracle,  cvx, crv, factory, curve_mock_builder, gov, weth, univ3_mock, univ2_mock, rewards_factory, booster, registry, vault_template):
  # try to build 2 pool with erc 20 tokens with plain and lending liquidity
  curve_mock_builder.build(4, False)
...
def test_create_4_coins_strategy_with_deposit_withdraw_in_target_coin_lending_pool(chain, treasury, common_health_check, base_fee_oracle,  cvx, crv, factory, curve_mock_builder, gov, weth, univ3_mock, univ2_mock, rewards_factory, booster, registry, vault_template):
  # try to build 2 pool with erc 20 tokens with plain and lending liquidity
  curve_mock_builder.build(4, False)
